...
from nara.evaluation.evaluate_dev import read_csv
from nara.inference.hybrid_experiment import INSTANT
...
def main():
    ...
    lines += ['', '## 해석', '',
        ...
        '재현: `uv run --locked python src/experiments/benchmark_on0.py --output NEW_DIRECTORY`, '
        '`uv run --locked python src/evaluation/summarize_on0.py --output NEW_DIRECTORY`.', '',
