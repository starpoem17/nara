...
from nara.inference.predictor import Limits, Predictor, Turn, compact
...
def main():
    ...
    sources = [
        Path('src/experiments/benchmark_grouping_time.py'),
        ...
        Path('src/cli.py'), Path('src/inference/predictor.py'), Path('src/inference/conversation.py'),
        Path('src/inference/engine.py'), Path('src/inference/legal_criteria.json'),
        Path('src/retrieval/search.py'), Path('src/inference/prompt.txt'), Path('data/dev.jsonl'),
    ]
