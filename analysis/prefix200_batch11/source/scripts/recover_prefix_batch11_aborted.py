...
from nara.prefix_predictor import SourceFirstPredictor, predict_notice, split_predictor
from nara.hypothesis6 import judge
from scripts.benchmark_prefix200 import ObservedLLM
...
def main():
    ...
    saved = OUT / 'first_pass'; saved.mkdir()
    ...
    for r in trace:
        ...
        for old_task, new_task in zip(r['trace'], current['trace']):
            assert old_task['items'] == new_task['items']
