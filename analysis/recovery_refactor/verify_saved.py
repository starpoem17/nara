...
Usage: uv run --locked python analysis/recovery_refactor/verify_saved.py SAVED_RUN
"""
...
def main():
    ...
    for name in ['data/dev.jsonl', 'data/항목표.json', 'data/정답스키마_디코딩.json', 'nara/hypothesis6.py']:
        assert hashlib.sha256(Path(name).read_bytes()).hexdigest() == manifest['source_sha256'][name], name
