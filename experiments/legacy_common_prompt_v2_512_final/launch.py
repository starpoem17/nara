...
os.chdir(root)
out=root/'analysis/common_prompt_v2_512_final'
...
env=dict(os.environ,PATH=str(root/'.venv/bin')+os.pathsep+os.environ.get('PATH',''),HF_HUB_OFFLINE='1',TRANSFORMERS_OFFLINE='1',TOKENIZERS_PARALLELISM='false',MAX_JOBS='2')
plan['environment_path_prepend']=str(root/'.venv/bin')
plan['initialization_attempts']=['analysis/common_prompt_v2_512','analysis/common_prompt_v2_512_run']
