...
from experiments.legacy_cod_plain_gemma_20260912.code.experiment_cod_plain import MODEL,PAPER
...
def main():
 ...
 (OUT/'cases.json').write_text(json.dumps(data,ensure_ascii=False,indent=2));(OUT/'src/cli.py').write_text(Path(__file__).read_text())
