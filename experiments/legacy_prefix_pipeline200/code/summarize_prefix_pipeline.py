...
def main():
    ...
    text += ['', f"1→11 대비 추론 시간 {delta['time_reduction_vs_batch11']:.2%} 감소. Macro 변화 {delta['macro_delta_vs_batch11']:+.6f}, Micro 변화 {delta['micro_delta_vs_batch11']:+.6f}.", '',
             ...
             '재현: `MAX_JOBS=2 uv run --locked python src/experiments/benchmark_prefix_pipeline.py --output NEW_DIRECTORY`',
             '검증: `python3 src/evaluation/summarize_prefix_pipeline.py`', '']
