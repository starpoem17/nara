...
def main():
    ...
    sources=['src/__init__.py','src/runtime.py','src/records.py','src/paths.py',
             ...
             'src/experiments/benchmark_prefix200.py','src/inference/prefix_predictor.py','src/inference/compact_predictor.py',
             'src/inference/compact_criteria.json','src/inference/predictor.py','src/inference/conversation.py','src/inference/engine.py','src/rules/qualification.py','src/rules/briefing.py',
             'src/experiments/benchmark_compact200.py','src/experiments/benchmark_grouping_time.py','data/dev.jsonl','data/항목표.json','data/정답스키마_디코딩.json']
