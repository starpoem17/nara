...
Completed 2026-09-11. Report: `docs/reports/analysis/on0_200/comparison.md`; structured results `comparison.json`, changed cells `judgment_changes.csv`. Runner `scripts/benchmark_on0.py`, scorer `scripts/summarize_on0.py`. No production default change.
