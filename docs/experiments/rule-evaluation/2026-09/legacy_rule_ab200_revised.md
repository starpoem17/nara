# How do the revised qualification rules compare on dev200?

Current judgment: **Dev-informed revision; no independent holdout validation is established.**

Reason and scope: Initial results informed rule changes. Historical local development evidence; no unseen-data or competition-server generalization is established.

## Run identity and conditions

Run ID: `legacy_rule_ab200_revised`. Historical start time: **unknown**. The available metadata does not establish an orchestration start; initialization/log/preparation timestamps were not substituted. Execution month: September 2026, supported by the original project records and original run names.
...
Dev-informed revision; no independent holdout validation is established.
...
[Retained execution directory](<../../../../experiments/legacy_rule_ab200_revised>) · [Execution metadata and original-file hashes](<../../../../experiments/legacy_rule_ab200_revised/run.json>)
...
- [report.json](<../../../../experiments/legacy_rule_ab200_revised/report.json>): original execution or analysis evidence.

## Predecessor

[legacy_rule_ab200](<legacy_rule_ab200.md>): Initial results informed rule changes.
...
- [Original detailed observation: rule_ab200_revised/report.md](<../../../../experiments/legacy_rule_ab200_revised/retained_documents/docs/reports/analysis/rule_ab200_revised/report.md>): immutable original-language evidence; current judgment is above.
...
- [source](<../../../../experiments/legacy_rule_ab200_revised/source>): retained source/evidence; execution snapshots and migration-time helpers are distinguished.

- [retained_documents](<../../../../experiments/legacy_rule_ab200_revised/retained_documents>): retained source/evidence; execution snapshots and migration-time helpers are distinguished.
