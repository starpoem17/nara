# Which judgments differ between the compared qualification rules?

Current judgment: **Saved-result difference analysis; scope is the compared rules and records.**

Reason and scope: Saved-result difference analysis; scope is the compared rules and records. Historical local development evidence; no unseen-data or competition-server generalization is established.

## Run identity and conditions

Run ID: `legacy_rule_difference_audit`. Historical start time: **unknown**. The available metadata does not establish an orchestration start; initialization/log/preparation timestamps were not substituted. Execution month: September 2026, supported by the original project records and original run names.
...
Saved-result difference analysis; scope is the compared rules and records.
...
[Retained execution directory](<../../../../experiments/legacy_rule_difference_audit>) · [Execution metadata and original-file hashes](<../../../../experiments/legacy_rule_difference_audit/run.json>)
