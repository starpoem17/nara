# How does the initially frozen briefing rule behave on dev200?

Current judgment: **Initial rule F1=66.67%, accuracy98.50%; superseded by a separately evaluated dev-informed revision.**

Reason and scope: Initial rule was frozen before per-record label inspection; the three observed errors led to revision. Historical local development evidence; no unseen-data or competition-server generalization is established.

## Run identity and conditions

Run ID: `legacy_v22_rule200`. Historical start time: **unknown**. The available metadata does not establish an orchestration start; initialization/log/preparation timestamps were not substituted. Execution month: September 2026, supported by the original project records and original run names.
...
Initial rule F1=66.67%, accuracy98.50%; superseded by a separately evaluated dev-informed revision.
...
[Retained execution directory](<../../../../experiments/legacy_v22_rule200>) · [Execution metadata and original-file hashes](<../../../../experiments/legacy_v22_rule200/run.json>)
...
- [legacy_v22_rule_revised](<legacy_v22_rule_revised.md>): Inspection of PPS-DEV-26/135/193 errors informed regex changes; input200, labels, and binary evaluation stayed the same.
