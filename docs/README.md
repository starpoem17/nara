...
| LJM original scanner and extractor + original Gemma prompt, independent dev200 runs | [LJM original experiment](experiments/ljm-original.md) |
...
- Colleague hypothesis experiments in `analysis/` must use uppercase colleague initials first: `<INITIALS>_<experiment_name>[_<date>]`, e.g. `LJM_original_v2_v8_20260912`. Apply this to new runs; preserve historical snapshots. See [maintenance rules](maintenance/structure-audit.md#maintenance-rules).
