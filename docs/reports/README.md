...
Read the concise owner first. Detailed reports live here; JSON/CSV/prompts/logs and frozen source remain in the linked artifact folder. Old `analysis/X/Y.md` maps to `docs/reports/analysis/X/Y.md`; old `output/X/Y.md` maps to `docs/reports/output/X/Y.md`. Unlinked artifact names inside a report refer to its artifact folder, identified at the top.
