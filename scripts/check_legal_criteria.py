...
def main():
    ...
    parser.add_argument('--output', default='analysis/legal_criteria_v1_context.json')
    ...
    path.write_text(json.dumps({'kind':'tokenizer-only; initial prompts, no retrieval/retries or inference',
        ...
        'criteria_sha256': hashlib.sha256(Path('nara/legal_criteria.json').read_bytes()).hexdigest(),
