...
from nara.hybrid_experiment import INSTANT, THINK, TimedLLM, merge
...
from scripts.benchmark_hybrid200 import dump, jsonl, safe
...
def main():
    ...
    paths = ['scripts/benchmark_on0.py', 'scripts/benchmark_hybrid200.py', 'scripts/benchmark_compact200.py',
             'nara/hybrid_experiment.py', 'nara/vllm_model.py', 'nara/inference.py','nara/conversation.py',
             'nara/prefix_predictor.py', 'nara/compact_predictor.py', 'nara/compact_criteria.json',
